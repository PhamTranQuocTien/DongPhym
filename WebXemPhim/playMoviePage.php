...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/moviePlayer.css">
    <script src="https://cdn.plyr.io/3.6.12/demo.js" crossorigin="anonymous"></script>
...
<body>
    <div class="main">
        ...
        <?php  
            ...
            // import detail movie
            include("./assets/components/app/playMovie/playMovie.php");
        ?>
        ...
        <div class="app">   
            <div class="grid wide">
                <div class="row">
                    <?php 
                        include("./assets/components/app/playMovie/playMovieContent.php");
